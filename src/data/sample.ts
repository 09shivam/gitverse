...
export const sampleGraph: GVGraph = {
  nodes: [
    ...
    { id: "r-docker", label: "moby/docker", kind: "repo", domain: "devops", createdAt: 2013, stars: 68, pagerank: 0.9, momentum: 0.32, activity: 600, contributors: 2200, forks: 19, openIssues: 2600, license: "Apache-2.0", language: "Go", owner: "moby", url: "https://mobyproject.org", lastPush: 2024, description: "Container runtime and tooling." },
